...
- **Readability**: Softened left wipe → mid overlay → frosted blur under content (`863f2ad` / `7da684c`). Later split-mask / nested-mask experiments removed the visible frost — restore the single-element panel first; soft-edge tweaks are secondary.
